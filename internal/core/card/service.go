...
func (s *Service) GetDueCards(ctx context.Context, deckID string, page, limit int) ([]*Card, int, error) {
...
func (s *Service) GetByDeckId(ctx context.Context, deckId string, page, limit int) ([]*Card, int, error) {
